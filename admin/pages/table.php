      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Registered Student</li>
          </ol>
        <h6 class="font-weight-bolder mb-0 pt-2">Registered Student</h6>
        </nav>
...
<input type="text" class="form-control" id="main_search" name="search" placeholder="Type here..." onfocus="focused(this)" onfocusout="defocused(this)">
          ...
          <div class="my-2">
              ...
              <form action="excel.php" class="d-inline" method="post">
                <div class="form-inline"></div>
                          <div class="btn-group px-5" role="group">
                          <button type="submit" name="toexcel" class="btn btn-primary bg-gradient-success d-md-inline-flex"><i class="fa fa-file-excel-o" aria-hidden="true" style="font-size:15px; margin-right:5px;"></i>Download as Excel</button>
        </div>
                        </form>
                         <div class="btn-group" role="group">
                        <form action="pdf.php" method="post">
                          <button type="submit" name="pdf" class="btn btn-danger bg-gradient-danger"><i class="fa fa-file-pdf-o" aria-hidden="true" style="font-size:15px; margin-right:5px;"></i>Download as PDF</button>
        </div>
                        </form>
                       </div>
</div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">MATRIC. NO/JAMB REG. NO</th>

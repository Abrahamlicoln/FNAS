...
if (isset($_POST['update3'])) {
    ...
    $sql = "SELECT id,fullname,email,phone,position,courseofstudy,level FROM officials where id='$student_id'";
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Update Official</li>
          </ol>
        <h6 class="font-weight-bolder mb-0 pt-2">Update Official Information</h6>
        </nav>
...
if ($numRow > 0) {
    ...
    <div id="layoutSidenav_content">
                ...
                <h5  class="pt-4 pb-0"> You are about to Update  <?php echo $row['fullname']; ?> Information</h5>
                    <div class="row mx-2 my-3">
  <div class="col-md-6 my-2 ">

         <form action="update4.php" method="post" enctype="multipart/form-data">
      <label for="name">Full Name</label>
    <input type="text" class="form-control" required  name ="fullname" placeholder="First name" value="<?php echo $row['fullname']; ?>" aria-label="First name">
  </div>
  <div class="col-md-6 my-2">
         <label for="name">Position</label>
    <input type="text" class="form-control" required  name ="position"  value="<?php echo $row['position']; ?>" placeholder="Last name" >
  </div>
  <div class="col-md-6 my-2">
  ...
  <div class="col-md-6 my-2">
    ...
    <input type="text" class="form-control" required  name ="course" value="<?php echo $row['courseofstudy']; ?>" placeholder="Couse of Study" >
  </div>
  <div class="col-md-6 my-2">
         <label for="name">Current level <i> e.g 100L,200L</label>
    <input type="text" class="form-control" required   name ="level" value="<?php echo $row['level']; ?>">
  </div>
...
<center><button class="btn btn-info btn-gradient-info
 my-5 m-auto text-center" style="width:150px;" name="update4" type="submit">Update</button></center>
</form>
<?php

...
if (isset($_POST['update'])) {
    ...
    $sql = "SELECT id,jamb_reg,name,mode_of_entry,department,course,date_of_birth FROM userdata where id='$student_id'";
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active  " href="../pages/table2.php">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Registered Student</a></li>
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Update Student</li>
          </ol>
        <h6 class="font-weight-bolder mb-0 pt-2">Update Student</h6>
        </nav>
...
if ($numRow > 0) {
    ...
    <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-3 shadow-lg" style="margin-right:100px; margin-left:10px;" >
                <h5  class="pt-4 pb-0"> You are about to Update  <?php echo $row['name']; ?> Information</h5>
                    <div class="row mx-2 my-3">
  <div class="col-md-6 my-2 ">

         <form action="update2.php" method="post" enctype="multipart/form-data">
      <label for="name">Full Name</label>
    <input type="text" class="form-control" required  name ="fullname" placeholder="First name" value="<?php echo $row['name']; ?>" aria-label="First name">
  </div>
  <div class="col-md-6 my-2">
         <label for="name">Jamb Reg No/Matric No</label>
    <input type="text" class="form-control" required  name ="matric" readonly value="<?php echo $row['jamb_reg']; ?>" placeholder="Last name" >
  </div>
  <div class="col-md-6 my-2">
         <label for="name">Department</label>
    <input type="text" class="form-control" required name ="department" value="<?php echo $row['department']; ?>">
  </div>
  <div class="col-md-6 my-2">
         <label for="name">Course of Study</label>
    <input type="text" class="form-control" required  name ="course" value="<?php echo $row['course']; ?>" placeholder="Couse of Study" >
  </div>
  <div class="col-md-6 my-2">
         <label for="name">Mode of Entry</label>
    <input type="text" class="form-control" required readonly  name ="mode" value="<?php echo $row['mode_of_entry']; ?>" placeholder="Mode of Entry" aria-label="Mode of Entry">
  </div>

  <div class="col-md-6 my-2">
       <label for="date">Date of Birth</label>
  <input type="date" class="form-control" required value = <?php echo $row['date_of_birth']; ?> name="date_of_birth" id="">
</div>
<div class="col-md-4 my-2">
    <input type="hidden" class="form-control" required  name ="id" value="<?php echo $row['id']; ?>" placeholder="ID" >
  </div>
<center><button class="btn btn-info btn-gradient-info
 my-5 m-auto text-center" style="width:150px;" name="save" type="submit">Update</button></center>
</form>
<?php
...
?>
      ...
      <footer class="footer text-center col-md-12 pb-4" >
